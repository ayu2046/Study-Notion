...
const sendOTP = async (req, res) =>  {
    ...
    try {
        ...
        //as this approach is not so optimal because we match the db collection of otp for uniqueness again and again so there are some services that generate the unique otp everytime
